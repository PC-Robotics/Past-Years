...
@Autonomous(name="x2SkystoneBLUE", group="TankBot")
public class DoubleSkystoneBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (positionVal > 0) {
            ...
            encoderLeftTurn();
            takeBreak();
            encoderDrive(0.6,1741,1741,1741,
                    1741,7);
            letGoBlock();
            takeBreak();
            takeBreak();
            takeBreak();
            encoderDrive(0.4,-2608,-2608,-2608,
                    -2608,7);
            takeBreak();
            encoderRightTurn();
            headingCalibrate();
            ...
            encoderLeftTurnEnd();
            takeBreak();
            encoderDrive(0.6,2658,2658,2658,
                    2658,7);
            letGoBlock();
            takeBreak();
            takeBreak();
            ...
            encoderLeftTurn();
            takeBreak();
            encoderDrive(0.6,2116,2116,2116,
                    2116,7);
            letGoBlock();
            takeBreak();
            takeBreak();
            takeBreak();
            encoderDrive(0.4,-3141,-3141,-3141,
                    -3141,7);
            takeBreak();
            encoderRightTurn();
            headingCalibrate();
            ...
            encoderLeftTurnEnd();
            takeBreak();
            encoderDrive(0.6,2983,2983,2983,
                    2983,7);
            letGoBlock();
            takeBreak();
            takeBreak();
            ...
            encoderLeftTurn();
            takeBreak();
            encoderDrive(0.6,2657,2657,2657,
                    2657,7);
            letGoBlock();
            takeBreak();
            takeBreak();
            takeBreak();
            encoderDrive(0.4,-1906,-1906,-1906,
                    -1906,7);
            takeBreak();
            encoderRightTurn();
            headingCalibrate();
            ...
            encoderLeftTurnEnd();
            takeBreak();
            encoderDrive(0.6,1906,1906,1906,
                    1906,7);
            letGoBlock();
            takeBreak();
            takeBreak();
