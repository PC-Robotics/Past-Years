...
@Autonomous(name="2xSkystoneRed", group="TankBot")
public class DoubleSkystoneRed extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //sleepRunning((int) (1300 * FBFactor));
        encoderDrive(0.6,566,566,566,
                566,7);
        ...
        if (positionVal > 0) {
            ...
            //THE KEY FOR DOUBLE SKYSTONE AUTO
            encoderDrive(0.4,342,-342,-342,
                    342,7);
            headingCalibrate();
            encoderDrive(0.3,875,875,875,
                    875,7);
            miniLiftingDown();
            grabbingBlock();
            takeBreak();
            takeBreak();
            encoderDrive(0.6,-500,-500,-500,
                    -500,7);
            takeBreak();
            encoderRightTurn();
            takeBreak();
            encoderDrive(0.6,1541,1541,1541,
                    1541,7);
            letGoBlock();
            takeBreak();
            takeBreak();
            takeBreak();
            encoderDrive(0.4,-2408,-2408,-2408,
                    -2408,7);
            takeBreak();
            encoderLeftTurn();
            headingCalibrate();
            takeBreak();
            encoderDrive(0.3,834,834,834,
                    834,7);
            grabbingBlock();
            takeBreak();
            takeBreak();
            encoderDrive(0.6,-708,-708,-708,
                    -708,7);
            takeBreak();
            encoderRightTurnEnd();
            takeBreak();
            encoderDrive(0.6,2458,2458,2458,
                    2458,7);
            letGoBlock();
            takeBreak();
            takeBreak();
            takeBreak();
            encoderDrive(0.4,-500,-500,-500,
                    -500,7);
            ...
            encoderRightTurn();
            takeBreak();
            encoderDrive(0.6,1916,1916,1916,
                    1916,7);
            letGoBlock();
            takeBreak();
            takeBreak();
            takeBreak();
            encoderDrive(0.4,-2941,-2941,-2941,
                    -2941,7);
            takeBreak();
            encoderLeftTurn();
            headingCalibrate();
            ...
            encoderRightTurnEnd();
            takeBreak();
            encoderDrive(0.6,2783,2783,2783,
                    2783,7);
            letGoBlock();
            takeBreak();
            takeBreak();
            ...
            encoderDrive(0.4,-706,706,706,
                    -706,7);
            headingCalibrate();
            encoderDrive(0.3,900,900,900,
                    900,7);
            miniLiftingDown();
            grabbingBlock();
            takeBreak();
            ...
            encoderRightTurn();
            takeBreak();
            encoderDrive(0.6,2457,2457,2457,
                    2457,7);
            letGoBlock();
            takeBreak();
            takeBreak();
            takeBreak();
            encoderDrive(0.4,-1706,-1706,-1706,
                    -1706,7);
            takeBreak();
            encoderLeftTurn();
            headingCalibrate();
            ...
            encoderRightTurnEnd();
            takeBreak();
            encoderDrive(0.6,1706,1706,1706,
                    1706,7);
            letGoBlock();
            takeBreak();
            takeBreak();
            takeBreak();
            encoderDrive(0.4,-767,-767,-767,
                    -767,7);
    ...
    public void encoderRightTurn() {
        ...
        encoderDrive(0.6,1010,-1010,1010,
                -1010,7);
