...
@Autonomous(name="Sky+TrayBLUE", group="TankBot")
public class SkyTrayBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (positionVal > 0) {
            ...
            strafeLeft((int) (800 * speedFactor)); //These may not be totally optimized
            ...
            takeBreak();
            strafeLeft((int) (6300 * speedFactor));
            liftingUp();
            headingCalibrate();
            ...
            takeBreak();
            miniLiftingUp();
            strafeRight((int) (2500 * speedFactor));
            liftingDown();
            sleepRunning((int) (2100 * FBFactor)); //May need to be a little more
            takeBreak();
            strafeRight((int) (1700 * speedFactor));
            ...
            strafeRight((int) (300 * speedFactor));
            ...
            sleepRunningBack((int) (1300 * FBFactor));
            takeBreak();
            strafeLeft((int) (6900 * speedFactor));
            liftingUp();
            headingCalibrate();
            sleepRunning((int) (1800 * FBFactor));
            letGoBlock();
            ...
            strafeRight((int) (1000 * speedFactor));
            ...
            sleepRunningBack((int) (1300 * FBFactor));
            takeBreak();
            strafeLeft((int) (7900 * speedFactor));
            liftingUp();
            headingCalibrate();
            ...
            takeBreak();
            miniLiftingUp();
            strafeRight((int) (2500 * speedFactor)); //3900 total
            liftingDown();
            sleepRunning((int) (2100 * FBFactor));
            takeBreak();
            strafeRight((int) (1700 * speedFactor));
